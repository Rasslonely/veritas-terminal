...
export interface VeritasGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface VeritasGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): VeritasGovernor;
  waitForDeployment(): Promise<this>;

  interface: VeritasGovernorInterface;
