...
export interface VeritasTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface VeritasTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): VeritasTimelock;
  waitForDeployment(): Promise<this>;

  interface: VeritasTimelockInterface;
